...
image: nasa_space_shuttle_challenger_BK4ByT5j.jpg
...
> [![image](Create_integrations_with_the_Notion_API_-_hero_bYdc2Ezi.png) **Create integrations with the Notion API | Notion Help – Notion Help Center**](https://www.notion.so/help/create-integrations-with-the-notion-api)\
> With Notion's API, you'll be able to create custom internal connections. Some of our partners may also require an internal connection token in order to link their platform to your Notion workspace - below, we'll walk you through how to set this up.\
